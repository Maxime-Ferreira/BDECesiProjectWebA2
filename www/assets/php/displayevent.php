    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-left">
            ...
            <p>
              <a class="btn btn-lg btn-primary" href="boutique.php" role="button">Détails</a>
            </p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p>
              <a class="btn btn-lg btn-primary" href="inscription.php" role="button">Inscrivez-vous</a>
            </p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          ...
          <h1>WEEK END SKI.</h1>
            <p>
            Venez avec le bde au week-end ski.
            </p>
            <p>
              <a class="btn btn-lg btn-primary" href="#" role="button">VENEZ !</a>
            </p>
          </div>
        </div>
      </div>
