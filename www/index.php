    ...
    <body>
        ...
        <main>
            <div class = "evenement"> Les évènements </div>
                ...
                <div class="card-deck">
                <div class="card">
                    <img class="card-img-top" src= "/www/assets/img/pull_cesi.jpeg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
...
?>
                ...
                <div class="card">
                <img class="card-img-top" src= "/www/assets/img/clé.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php

$req = $bdd->prepare('CALL SelectTitre (:type)');
$req->bindValue(':type', "usb", PDO::PARAM_STR);
$req->execute();
$title_prod = $req->fetchAll();
foreach ($title_prod as $title) {
    echo $title['Libelle'];
...
?>
                ...
                <div class="card">
                <img class="card-img-top" src= "/www/assets/img/decapsuleur.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php

$req = $bdd->prepare('CALL SelectTitre (:type)');
$req->bindValue(':type', "Décap", PDO::PARAM_STR);
$req->execute();
$title_prod = $req->fetchAll();
foreach ($title_prod as $title) {
    echo $title['Libelle'];
...
?>
                ...
                <div class="card-deck">
                <div class="card">
                <img class="card-img-top" src="/www/assets/img/porte_clé.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php

$req = $bdd->prepare('CALL SelectTitre (:type)');
$req->bindValue(':type', "porte_clé", PDO::PARAM_STR);
$req->execute();
$title_prod = $req->fetchAll();
foreach ($title_prod as $title) {
    echo $title['Libelle'];
...
?>
                ...
                <div class="card">
                <img class="card-img-top" src="/www/assets/img/tee-shirt.jpeg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php

$req = $bdd->prepare('CALL SelectTitre (:type)');
$req->bindValue(':type', "tee-shirt", PDO::PARAM_STR);
$req->execute();
$title_prod = $req->fetchAll();
foreach ($title_prod as $title) {
    echo $title['Libelle'];
...
?>
                ...
                <div class="card">
                <img class="card-img-top" src="/www/assets/img/mug.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
